        ...
        if(rpchannel){
            ...
            if (walkway != null){
                ...
                if(cats.length != 0) for(let [id, cat] of cats){
                    ...
                    if (catId == channelFA.topic.split('-')[0] && (Config.globalObjects.find(obj => obj.name.toLowerCase() == walkway.toLowerCase()) || Config.globalObjects.find(obj => obj.children.find(child => child.toLowerCase() == walkway.toLowerCase())))){

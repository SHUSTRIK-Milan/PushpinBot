        ...
        if(rpchannel){
            ...
            if(code == '1'){
                ...
                if(staff.size == 0){
                    ...
                    guild.channels.cache.get(`860559004278325268`).send(`<@&${Config.departments.fire[2]}>, **${msgDate.author.tag} вызвал пожарную службу:**`, {embed: {
                            thumbnail: {
                ...
                if(staff.size == 0){
                    ...
                    guild.channels.cache.get(`860558870962110475`).send(`<@&${Config.departments.police[2]}>, **${msgDate.author.tag} вызвал полицию:**`, {embed: {
                            thumbnail: {
                ...
                if(staff.size == 0){
                    ...
                    guild.channels.cache.get(`860558917762940997`).send(`<@&${Config.departments.med[2]}>, **${msgDate.author.tag} вызвал медицинскую службу:**`, {embed: {
                            thumbnail: {

...
async function updateChannels(){
    ...
    for (outAllChannel of allChannels){
        ...
        if(Config.streets.find(street => `«${street.name.toLowerCase()}»` == `«${outAllChannel[1].name.toLowerCase()}»`) == undefined) s.push(`«${street.name.toLowerCase()}» - «${outAllChannel[1].name.toLowerCase()}»`);
